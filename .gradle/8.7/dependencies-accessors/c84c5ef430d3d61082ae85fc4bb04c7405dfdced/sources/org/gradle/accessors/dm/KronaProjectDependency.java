...
@NonNullApi
public class KronaProjectDependency extends DelegatingProjectDependency {

    @Inject
    public KronaProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
